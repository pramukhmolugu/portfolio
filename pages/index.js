  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white">
        ...
        <section id="about" className="py-32 bg-[#0a0a0a]">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="card-hover bg-[#1a1a1a]/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-800">
        ...
        {/* Footer */}
        <footer className="bg-[#0a0a0a] py-6 text-center text-gray-500 text-sm border-t border-gray-800">
